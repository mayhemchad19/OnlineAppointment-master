...
namespace OnlineAppointment.Controllers
{
    public class UserRolesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "RoleID,RoleName,RoleLevel")] UserRole userRole)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "RoleID,RoleName,RoleLevel")] UserRole userRole)
        {
            if (ModelState.IsValid)
            {
