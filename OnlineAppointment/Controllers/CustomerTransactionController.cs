...
namespace OnlineAppointment.Controllers
{
    public class CustomerTransactionController : Controller
    {
        ...
        // GET: CustomerTransaction/Details/5
        ...
        // GET: CustomerTransaction/Create
        ...
        // POST: CustomerTransaction/Create
        ...
        // GET: CustomerTransaction/Edit/5
        ...
        // POST: CustomerTransaction/Edit/5
        // To protect from overposting attacks, enable the specific properties you want to bind to, for 
        // more details see https://go.microsoft.com/fwlink/?LinkId=317598.
        [HttpPost]
        [ValidateAntiForgeryToken]
        ...
        // GET: CustomerTransaction/Delete/5
        ...
        // POST: CustomerTransaction/Delete/5
