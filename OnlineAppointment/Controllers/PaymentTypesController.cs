...
namespace OnlineAppointment.Controllers
{
    public class PaymentTypesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "PaymentTypeID,PaymentTypeName,PaymentTypeStatus")] PaymentType paymentType)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "PaymentTypeID,PaymentTypeName,PaymentTypeStatus")] PaymentType paymentType)
        {
            if (ModelState.IsValid)
            {
