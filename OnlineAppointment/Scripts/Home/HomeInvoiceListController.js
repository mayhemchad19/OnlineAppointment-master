(function () {
    app.controller('HomeInvoiceList', function ($scope, $http, $filter) {
        ...
        function GetAllSales() {
            $http.get('/EmployeeBilling/GetAllSales')
      ...
      /*      GetProducts();*/
            $http.get('/EmployeeBilling/GetInvoiceBySalesId', { params: { salesId: salesId } })
                .then(function (response) {
                    var data = response.data;
           ...
           /*         $scope.Sale.FirstName = $scope.OrderList[0].User.FirstName;*/
